...
vim.keymap.set('n', '<leader>p', ':Telescope neovim-project history<CR>', { desc = 'Open [p]roject history' })
...
-- Keymap for femaco
vim.keymap.set('n', '<leader>f', require('femaco.edit').edit_code_block, { desc = 'Edit codeblock in [f]emaco' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>ka', vim.lsp.buf.add_workspace_folder, '[W]orkspace [A]dd Folder')
  nmap('<leader>kr', vim.lsp.buf.remove_workspace_folder, '[W]orkspace [R]emove Folder')
